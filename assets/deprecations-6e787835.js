import{i as o,c as e,t as c}from"./entry-client-8aa7ecb6.js";import{M as n}from"./markdown-4e7b44d8.js";import{C as s}from"./caption-f0432936.js";import{P as r,S as l}from"./property-34334485.js";import{S as i}from"./subtitle-9d8b2e13.js";const u=c('<div><div class="mb12"></div><a id="types-function-zoom-property" class="anchor"></a></div>',6);function v(){return(()=>{const t=u.cloneNode(!0),a=t.firstChild,p=a.nextSibling;return o(t,e(n,{content:`# Deprecations
...
## Function
`}),a),o(t,e(s,{theme:"warning",get children(){return e(n,{content:`
...
`}),a),o(t,e(r,{headingLevel:"3",id:"function-stops",children:"stops"}),a),o(t,e(i,{children:"Required (except for `identity` functions) [array](/maplibre-gl-js-docs/style-spec/types/#array)."}),a),o(t,e(n,{content:'\nA set of one input value and one output value is a "stop." Stop output values must be literal values (i.e. not functions or expressions), and appropriate for the property. For example, stop output values for a `fill-color` function property must be [colors](/maplibre-gl-js-docs/style-spec/types/#color).\n'}),a),o(t,e(r,{headingLevel:"3",id:"function-property",children:"property"}),a),o(t,e(i,{get children(){return e(n,{content:`
...
`}),a),o(t,e(r,{headingLevel:"3",id:"function-base",children:"base"}),a),o(t,e(i,{get children(){return e(n,{content:`
...
`}),a),o(t,e(r,{headingLevel:"3",id:"function-default",children:"default"}),a),o(t,e(n,{content:`
...
`}),a),o(t,e(r,{headingLevel:"3",id:"function-colorSpace",children:"colorSpace"}),a),o(t,e(i,{get children(){return e(n,{content:'\nOptional [string](/maplibre-gl-js-docs/style-spec/types/#string). One of `"rgb"`, `"lab"`, `"hcl"`.\n'})}}),a),o(t,e(n,{content:`
...
: Use the HCL color space to interpolate color values, interpolating the Hue, Chroma, and Luminance channels individually.
            ...
            `}),a),o(a,e(l,{supportItems:{"basic functionality":{js:"0.10.0",android:"2.0.1",ios:"2.0.0",macos:"0.1.0"},"`property`":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`code`":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`exponential` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`interval` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`categorical` type":{js:"0.18.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`identity` type":{js:"0.26.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`default`":{js:"0.33.0",android:"5.0.0",ios:"3.5.0",macos:"0.4.0"},"`colorSpace`":{js:"0.26.0"}}})),o(t,e(n,{content:`
...
## Other filter
`}),null),o(t,e(s,{theme:"warning",get children(){return e(n,{content:`
