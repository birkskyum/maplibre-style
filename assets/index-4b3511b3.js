import{g as i,i as o,c as s,t as n}from"./entry-client-11014974.js";import{M as r}from"./markdown-4777c4f5.js";import{s as a}from"./v8-704d4818.js";const p=n("<div>");function m(){const t=`
# Sprite
...
- \`content\`: An array of four numbers, with the first two specifying the left, top corner, and the last two specifying the right, bottom corner. If present, and if the icon uses [\`icon-text-fit\`](/maplibre-gl-style-spec/layers/#layout-symbol-icon-text-fit), the symbol's text will be fit inside the content box.
