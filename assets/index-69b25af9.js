import{g as Q,s as xt,d as St,e as vt,t as X,a as n,i,c as e}from"./entry-client-11014974.js";import{M as a}from"./markdown-4777c4f5.js";import{s as d}from"./v8-704d4818.js";import{I as o}from"./items-976cd8fb.js";import{C as s}from"./caption-ced9c15f.js";import"./property-21af0297.js";import"./subtitle-9c444be0.js";const wt="_image_1st6w_1",kt={image:wt},Tt=X('<img alt="">');function c(u){const t=`/img/src/${u.imageId}.png`;return(()=>{const y=Q(Tt);return xt(y,"src",t),St(()=>vt(y,kt.image)),y})()}function p(u,t){const h=u.map(l=>({ref:d[`${l}_${t}`],kind:l,section:`${l}-${t}`})).reduce((l,r)=>(Object.keys(r.ref).forEach(g=>{r.ref[g].kind=r.kind,r.ref[g].section=r.section,l[g]=r.ref[g]}),l),{});return Object.keys(h).sort().reduce((l,r)=>(l[r]=h[r],l),{})}const It=X('<div><!#><!/><!#><!/><hr class="my36"><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/><!#><!/>');function Et(){const u=["background","fill","line","symbol","raster","circle","fill-extrusion","heatmap","hillshade"];return(()=>{const t=Q(It),y=t.firstChild,[h,l]=n(y.nextSibling),r=h.nextSibling,[g,Z]=n(r.nextSibling),ee=g.nextSibling,te=ee.nextSibling,[m,ne]=n(te.nextSibling),ie=m.nextSibling,[b,ae]=n(ie.nextSibling),le=b.nextSibling,[$,re]=n(le.nextSibling),oe=$.nextSibling,[_,se]=n(oe.nextSibling),ce=_.nextSibling,[f,pe]=n(ce.nextSibling),ge=f.nextSibling,[x,ye]=n(ge.nextSibling),ue=x.nextSibling,[S,he]=n(ue.nextSibling),de=S.nextSibling,[v,me]=n(de.nextSibling),be=v.nextSibling,[w,$e]=n(be.nextSibling),_e=w.nextSibling,[k,fe]=n(_e.nextSibling),xe=k.nextSibling,[T,Se]=n(xe.nextSibling),ve=T.nextSibling,[I,we]=n(ve.nextSibling),ke=I.nextSibling,[L,Te]=n(ke.nextSibling),Ie=L.nextSibling,[M,Le]=n(Ie.nextSibling),Me=M.nextSibling,[A,Ae]=n(Me.nextSibling),Ce=A.nextSibling,[C,je]=n(Ce.nextSibling),Ne=C.nextSibling,[j,De]=n(Ne.nextSibling),Ee=j.nextSibling,[N,Ye]=n(Ee.nextSibling),Ge=N.nextSibling,[D,Oe]=n(Ge.nextSibling),qe=D.nextSibling,[E,ze]=n(qe.nextSibling),Pe=E.nextSibling,[Y,Re]=n(Pe.nextSibling),Ve=Y.nextSibling,[G,We]=n(Ve.nextSibling),Je=G.nextSibling,[O,Ue]=n(Je.nextSibling),Be=O.nextSibling,[q,He]=n(Be.nextSibling),Fe=q.nextSibling,[z,Ke]=n(Fe.nextSibling),Qe=z.nextSibling,[P,Xe]=n(Qe.nextSibling),Ze=P.nextSibling,[R,et]=n(Ze.nextSibling),tt=R.nextSibling,[V,nt]=n(tt.nextSibling),it=V.nextSibling,[W,at]=n(it.nextSibling),lt=W.nextSibling,[J,rt]=n(lt.nextSibling),ot=J.nextSibling,[U,st]=n(ot.nextSibling),ct=U.nextSibling,[B,pt]=n(ct.nextSibling),gt=B.nextSibling,[H,yt]=n(gt.nextSibling),ut=H.nextSibling,[F,ht]=n(ut.nextSibling),dt=F.nextSibling,[K,mt]=n(dt.nextSibling),bt=K.nextSibling,[$t,_t]=n(bt.nextSibling);return i(t,e(a,{get content(){return`# Layers
...
## Layer properties
`}}),h,l),i(t,e(o,{get entry(){return d.layer}}),g,Z),i(t,e(a,{content:`
...
`}),m,ne),i(t,e(c,{imageId:"layer-background",alt:"Vintage map style with a brown halftone background pattern."}),b,ae),i(t,e(s,{get children(){return e(a,{get content(){return"\nThe [Vintage map style](https://blog.mapbox.com/designing-the-vintage-style-in-mapbox-studio-9da4aa2a627f) uses a custom SVG [`background-pattern`](/maplibre-gl-style-spec/layers/#paint-background-background-pattern) to achieve a textured vintage look.\n"}})}}),$,re),i(t,e(o,{headingLevel:"3",get entry(){return p(["layout","paint"],"background")}}),_,se),i(t,e(a,{content:`
## fill
...
`}),z,Ke),i(t,e(c,{imageId:"layer-fill-extrusion",alt:"Map of Europe and North Africa with countries extruded to various heights."}),P,Xe),i(t,e(s,{get children(){return e(a,{get content(){return"\nThis map uses an external dataset to provide data-driven values for the [`fill-extrusion-height`](/maplibre-gl-style-spec/layers/#paint-fill-extrusion-fill-extrusion-height) paint property of various [country polygons](https://blog.mapbox.com/high-resolution-administrative-country-polygons-in-studio-57cf4abb0768) in a fill-extrusion layer.\n"}})}}),R,et),i(t,e(o,{headingLevel:"3",get entry(){return p(["layout","paint"],"fill-extrusion")}}),V,nt),i(t,e(a,{content:`
## heatmap

A \`heatmap\` style layer renders a range of colors to represent the density of points in an area.
`}),W,at),i(t,e(c,{imageId:"layer-heatmap",alt:"Dark map with a heatmap layer glowing red inside and white outside."}),J,rt),i(t,e(s,{get children(){return e(a,{get content(){return`
[This visualization of earthquake data](/maplibre-gl-js-docs/example/heatmap-layer/) uses a heatmap layer with carefully defined [paint](/maplibre-gl-style-spec/layers/#paint-property) properties to highlight areas where earthquake frequency is high and many points are clustered closely together.
