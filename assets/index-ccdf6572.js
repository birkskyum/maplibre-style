...
As of [v0.41.0](https://github.com/maplibre/maplibre-gl-js/blob/main/CHANGELOG.md#0410-october-11-2017), [property expressions](/maplibre-gl-style-spec/expressions) is the preferred method for styling features based on zoom level or the feature's properties. Zoom and property functions are still supported, but will be phased out in a future release.
`}})}}),s,N),n(t,e(i,{content:`
...
`}),p,B),n(t,e(a,{headingLevel:"3",id:"function-stops",children:"stops"}),c,R),n(t,e(r,{get children(){return e(i,{get content(){return"Required (except for `identity` functions) [array](/maplibre-gl-style-spec/types/#array)."}})}}),u,D),n(t,e(i,{get content(){return'\nA set of one input value and one output value is a "stop." Stop output values must be literal values (i.e. not functions or expressions), and appropriate for the property. For example, stop output values for a `fill-color` function property must be [colors](/maplibre-gl-style-spec/types/#color).\n'}}),h,M),n(t,e(a,{headingLevel:"3",id:"function-property",children:"property"}),d,W),n(t,e(r,{get children(){return e(i,{get content(){return`
Optional [string](/maplibre-gl-style-spec/types/#string).
`}})}}),f,K),n(t,e(i,{get content(){return`
If specified, the function will take the specified feature property as an input. See [Zoom Functions and Property Functions](/maplibre-gl-style-spec/types/#function-zoom-property) for more information.
`}}),m,Q),n(t,e(a,{headingLevel:"3",id:"function-base",children:"base"}),y,X),n(t,e(r,{get children(){return e(i,{get content(){return`
Optional [number](/maplibre-gl-style-spec/types/#number). Default is ref.function.base.default.
...
The rendered values of [color](/maplibre-gl-style-spec/types/#color), [number](/maplibre-gl-style-spec/types/#number), and [array](/maplibre-gl-style-spec/types/#array) properties are interpolated between stops. [Boolean](/maplibre-gl-style-spec/types/#boolean) and [string](/maplibre-gl-style-spec/types/#string) property values cannot be interpolated, so their rendered values only change at the specified stops.
